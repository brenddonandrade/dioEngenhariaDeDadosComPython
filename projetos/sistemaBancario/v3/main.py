...
# Precisamos deixar nosso código mais modularizado, criando funções para as operações existentes: sacar, depositar e visualizar extrato.
# Além disto, precisamos criar duas novas funções: criar usuário (clente do banco) e criar conta corrente (vincular com o usuário)
